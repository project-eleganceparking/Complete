      ...
      <div id="primary" class="content-area column full">
        <main id="main" class="site-main">
          ...
          <table width=100%>
            ...
            <tr><td colspan=2><br>  
          <!-- 글쓰기 시작 -->
			<form method='post' action='./modify_notice.do'>
          <!--  <form name="write" id="write" enctype="multipart/form-data"> -->
           <table width='100%'>
              <tr><td>내용</td><td><textarea cols='30' name='contents' id='contents' rows='10'></textarea></td></tr>
              <tr><td colspan='2'>         
   	  		<input type='submit' value="수정 완료" class="listbutton"> 
          ...
          <table>
           <tr>              
            <td>      
              <a href="javascript:show('modify','./modify_notice.do')"><input type="button"; value="수정"; class="downbutton"; ></a>    
