...
<head>  
  ...
  <style>  
    ...
    .upbutton { float:right; margin-left:5px; margin-bottom:10px; width:100px; }    
    .downbutton { float:right; margin-left:5px; margin-top:10px; width:80px; }
  ...
  if(cmd == 'modify') {
    form.submit.value = '수정';
  } else if(cmd == 'delete' ) {
    form.submit.value = '삭제';
  }
  }
      ...
      <div id="primary" class="content-area column full">
        <main id="main" class="site-main">
          ...
          <table>
           <tr>              
            <td> 
              <a href="./notice_write.do"><input type="button"; value="글쓰기"; class="upbutton"; ></a>
              <a href="./notice.do"><input type="button"; value="목록"; class="upbutton"; ></a>    
            </td>
           </tr>
          </table>
          ...
          <table width=100%>
            ...
            <tr><td>            
            <b>제목 : ${notice.subject} </b>
            <br>
            <b>작성자 : </b><a>${notice.managername}</a>
            <br>
            <b>작성일 : </b><a> ${notice.idate}</a>
            <br>
            <b>조회수 : </b><a>${notice.rcount}</a>               
            <br>
            </td></tr>
            <tr><td colspan=2 height=1 background=./source/img/dotline.gif></td></tr>
            <tr><td colspan=2><br>  
            <img src='./source/notice_img/${notice.filename}' width=400px height=340px><hr>
            <c:set var="contents1" value="${notice.contents}" />
          ...
          <table>
           <tr>              
            <td>      
              <a href="javascript:show('modify','./try_modify_notice.do')"><input type="button"; value="수정"; class="downbutton"; ></a>    
             <a href="javascript:show('delete','./notice_delete.do')"><input type="button"; value="삭제"; class="downbutton"; ></a>
            </td>
           </tr>
          </table>
          ...
          <!-- 글 수정 및 삭제를 위한 암호 입력 -->
          <div id='enter' style='display:none' class="hiddenmenu">
            <form method='post' action='' name='my'>
                  비밀번호 : <input type=password name=password size=10>
            <input type=hidden  name='bid' value='${notice.bid}'>
            <input type=hidden name='ismanager' value='${user.ismanager}'>
            <input type=submit name='submit' value=' '>
            <input type=reset name='reset' value='취소' onClick='hide()'>
            </form>
          </div>
